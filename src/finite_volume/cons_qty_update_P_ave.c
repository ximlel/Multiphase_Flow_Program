	...
	for(int j = 0; j < cp[k][0]; j++)
		{
			...
			scv[j].RHO = cv.RHO_add_c[k][l_n] + cv.RHO_add_c[k][j] - scv[cp[k][0]*12+1].RHO;
			scv[j].P   = cv.P_add_c[k][l_n]   + cv.P_add_c[k][j]   - scv[cp[k][0]*12+1].P;

			scv[j+cp[k][0]].RHO = cv.RHO_star[k][l_n] + cv.RHO_add_c[k][j] - scv[cp[k][0]*12+1].RHO;
			scv[j+cp[k][0]].P   = cv.P_star[k][l_n]   + cv.P_add_c[k][j]   - scv[cp[k][0]*12+1].P;

			scv[j+cp[k][0]*2].RHO = cv.RHO_minus_c[k][l_n] + cv.RHO_add_c[k][j] - scv[cp[k][0]*12+1].RHO;
			scv[j+cp[k][0]*2].P   = cv.P_minus_c[k][l_n]   + cv.P_add_c[k][j]   - scv[cp[k][0]*12+1].P;

			scv[j+cp[k][0]*3].RHO = cv.RHO_add_c[k][l_n] + cv.RHO_star[k][j] - scv[cp[k][0]*12+1].RHO;
			scv[j+cp[k][0]*3].P   = cv.P_add_c[k][l_n]   + cv.P_star[k][j]   - scv[cp[k][0]*12+1].P;

			scv[j+cp[k][0]*4].RHO = cv.RHO_star[k][l_n] + cv.RHO_star[k][j] - scv[cp[k][0]*12+1].RHO;
			scv[j+cp[k][0]*4].P   = cv.P_star[k][l_n]   + cv.P_star[k][j]   - scv[cp[k][0]*12+1].P;

			scv[j+cp[k][0]*5].RHO = cv.RHO_minus_c[k][l_n] + cv.RHO_star[k][j] - scv[cp[k][0]*12+1].RHO;
			scv[j+cp[k][0]*5].P   = cv.P_minus_c[k][l_n]   + cv.P_star[k][j]   - scv[cp[k][0]*12+1].P;

			scv[j+cp[k][0]*6].RHO = cv.RHO_add_c[k][l_n] + cv.RHO_minus_c[k][j] - scv[cp[k][0]*12+1].RHO;
			scv[j+cp[k][0]*6].P   = cv.P_add_c[k][l_n]   + cv.P_minus_c[k][j]   - scv[cp[k][0]*12+1].P;

			scv[j+cp[k][0]*7].RHO = cv.RHO_star[k][l_n] + cv.RHO_minus_c[k][j] - scv[cp[k][0]*12+1].RHO;
			scv[j+cp[k][0]*7].P   = cv.P_star[k][l_n]   + cv.P_minus_c[k][j]   - scv[cp[k][0]*12+1].P;

			scv[j+cp[k][0]*8].RHO = cv.RHO_minus_c[k][l_n] + cv.RHO_minus_c[k][j] - scv[cp[k][0]*12+1].RHO;
			scv[j+cp[k][0]*8].P   = cv.P_minus_c[k][l_n]   + cv.P_minus_c[k][j]   - scv[cp[k][0]*12+1].P;
		}
...
{	
	...
	for (int j = 0; j < cp[k][0]*12+1; j++)
		for (int i = j+1; i < cp[k][0]*12+1; i++)
			delta_U_e -= 0.5*scv[j].vol/cv->vol[k]*scv[i].vol/cv->vol[k]*(scv[j].RHO-scv[i].RHO)*(scv[j].P-scv[i].P)/scv[cp[k][0]*12+1].RHO;
