...
double Riemann_solver_exact(double * U_star, double * P_star, double gamma_L, double gamma_R, double u_L, double u_R, double p_L, double p_R, double c_L, double c_R, int * CRW, double tol, int N)
{
